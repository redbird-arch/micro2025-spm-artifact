...
cp figures/cachesize-study/all-cachesize-speedup-overBingo.pdf ./figures/reproduce/Fig_18.pdf
...
cp figures/linkstudy/all-speedup-link-widths.pdf ./figures/reproduce/Fig_19.pdf
...
cp figures/violin/all-prepush-breakdown-percentage.pdf ./figures/reproduce/Fig_4.pdf
