...
int main(int argc, char *argv[]) {
  ...
  printf("number_boxes %d, space_elem %dkB, space_mem %dkB, space_mem2 %dkB, "
         "box_mem %dkB.\n",
         dim_cpu.number_boxes, dim_cpu.space_elem >> 10,
         dim_cpu.space_mem >> 10, dim_cpu.space_mem2 >> 10,
         dim_cpu.box_mem >> 10);
#ifdef DUMP_OUTPUT
  ...
  for (int i = 0; i < dim_cpu.box_mem; i += 64) {
    volatile char c = ((char *)box_cpu)[i];
  }
  for (int i = 0; i < dim_cpu.space_mem; i += 64) {
    volatile char c = ((char *)rv_cpu)[i];
    volatile char x = ((char *)fv_cpu)[i];
  }
  for (int i = 0; i < dim_cpu.space_mem2; i += 64) {
    volatile char c = ((char *)qv_cpu)[i];
  }
  printf("Warm up done.");
  m5_reset_stats(0, 0);
#endif
  ...
  printf("%15.12f s, %15.12f % : VARIABLES\n", (float)(time1 - time0) / 1000000,
         (float)(time1 - time0) / (float)(time7 - time0) * 100);
  printf("%15.12f s, %15.12f % : INPUT ARGUMENTS\n",
         (float)(time2 - time1) / 1000000,
         (float)(time2 - time1) / (float)(time7 - time0) * 100);
  printf("%15.12f s, %15.12f % : INPUTS\n", (float)(time3 - time2) / 1000000,
         (float)(time3 - time2) / (float)(time7 - time0) * 100);
  printf("%15.12f s, %15.12f % : dim_cpu\n", (float)(time4 - time3) / 1000000,
         (float)(time4 - time3) / (float)(time7 - time0) * 100);
  printf("%15.12f s, %15.12f % : SYS MEM: ALO\n",
         (float)(time5 - time4) / 1000000,
         (float)(time5 - time4) / (float)(time7 - time0) * 100);
